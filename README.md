...
CocoAttributedStringBuilder is released under an MIT license. See [LICENSE](https://github.com/CocoAttributedStringBuilder/master/LICENSE) for more information.
